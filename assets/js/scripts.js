/*===================================
Author       : Bangar Rushal.
Template Name: Matoshri College of Engineering & Research Centre
Version      : 1.0
===================================*/
...
(function ($) {
    ...
    *===================================*/
    ...
    $('#classrooms-tab').on('click', function (e) {
        var $portfolio_selectors = $('.portfolio_container');
        $portfolio_selectors.ready(function () {
            setTimeout(function () {
                $portfolio_selectors.find('.portfolio-item').removeClass('animation').removeClass('animated'); // avoid problem to filter after window resize
  ...
  *===================================*/
    ...
    *===================================*/
    ...
    $(document).on('click', '.about-more', function () {
        $(this).prev().toggleClass('about-collapsed');
        $(this).children().toggleClass('ti-angle-double-up', 'ti-angle-double-down');
    });
	...
	$(document).on('click', '.speaker', function (e){
		...
		$().articulate('rate', 0.9);
		//$().articulate('setVoice','name',"Google US English");
		//$().articulate('setVoice','name',"Microsoft Mark - English (United States)");
		$().articulate('setVoice','name',"Microsoft Zira - English (United States)");
		//$().articulate('setVoice','name','Google हिन्दी');
		$().articulate('ignore',"img");
		...
		if (speaking) {
			...
			$('.speaker i').removeClass('fa fa-volume-mute');
			$('.speaker i').addClass('fa fa-volume-up');
		} else {
			$('.page-content').articulate('speak');
			$('.speaker i').removeClass('fa fa-volume-up');
			$('.speaker i').addClass('fa fa-volume-mute');
